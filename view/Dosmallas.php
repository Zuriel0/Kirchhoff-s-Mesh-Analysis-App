...
<div >
    <div id="flujo">
      <div id="box-del">
        <i class="bi bi-arrow-clockwise custome-size icon-arrow" value="1" id=""></i>
      </div>
    </div>
    <div id="flujo2">
      <div id="box-del2">
        <i class="bi bi-arrow-counterclockwise custome-size icon-arrow2" value="2"></i>
      </div>
    </div>
    <button class="btn btn-light" id="button-change1" onclick="flush('flujo');"><i class="bi bi-arrow-clockwise custome-size"></i></button>
    <button class="btn btn-light" id="button-change2" onclick="flush('flujo2');"><i class="bi bi-arrow-counterclockwise custome-size"></i></button>
    ...
    <button class="btn btn-light" id="button-changeSource1" onclick="flushSource('flujoSourse');"><i class="bi bi-arrow-clockwise custome-size-source"></i></button>
    <button class="btn btn-light" id="button-changeSource2" onclick="flushSource('flujoSourse2');"><i class="bi bi-arrow-counterclockwise custome-size-source"></i></button>

    <div class="row align-items-center" id="img-cir">
      <img src="img/circuito.svg" height="300px" alt="" id="img-cir-chan">
    </div>
